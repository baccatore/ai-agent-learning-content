...
Today, you'll get hands-on experience with an "AI agent."
No complicated steps are involved. Everything can be done from your web browser.
...
1. Open the following URL in your web browser (the instructor will provide it)
2. If you're not logged in to GitHub, please log in
...
2. Click the **"New issue"** button in the upper right
3. Choose one of the templates below and customize it to fit your own work
...
4. Once you've written your content, click **"Submit new issue"**
...
1. Click the **"Pull requests"** tab on the repository page
2. Open the PR that corresponds to your task
3. Click the **"Files changed"** tab to review the deliverable
...
1. **What surprised you**: What was the most surprising thing?
...
In the next session (Session 1), we'll learn how AI agents work
